...
def run():
     ...
     while 1:
          ...
          if menu ==1:
               ...
               print("이제부터는 마법 심볼이 있는 칸에 보이지 않는 벽을 기억하며 도달해야 합니다.\n")
               print("자기 차례에는 엔터를 눌러 주사위를 던져나온 숫자만큼 자기 마법사를 움직입니다.")
               print("움직일 때는 W, A, S, D를 입력하여 가로나 세로, 어느 방향이든 움직일 수 있고 중간에 방향을 바꿔도 됩니다.")
               ...
               print("파란색 마법 심볼 칸에 도착하면 도착한 플레이어가 점수를 1 얻고 새 마법 심볼 칩이 세팅됩니다.\n")
               print("한 사람이 5개의 마법 심볼을 모으면 게임이 끝나며 승리합니다.\n")
               time.sleep(2)
